from js import document 
        ...
        class InputLog(): def __init__(self,element_id): 
            self.element_id = element_id 
            self._element = None 
        
        @property
        def element(self): """Return the dom element""" 
        ...
        text = "Keypress: Key code: " + str(event.keyCode) + \ " Key: " + str(event.key) + " at: " + getTime() 
